...
export function AttendeeList() {
  ...
  useEffect(() => {
    ...
    const url = new URL("http://localhost:3000/events/9e9bd979-9d10-4915-b339-3786b1634f33/attendees");
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex gap-3 items-center">
        ...
        <div className="flex items-center gap-3 px-3 py-1.5 w-72 border border-white/10 bg-transparent rounded-lg">
          ...
          <tr>
            ...
            <TableCell className="text-right" colSpan={3}>
              ...
              <div className="flex gap-1.5">
                  ...
                  <IconButton onClick={backToNextPage} disabled={page === 1}>
